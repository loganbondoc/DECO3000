...
if st.button("Generate"):
    ...
    if user_data and accommodation_data:
        ...
        persona = do_wordware("persona-prompt-id", inputs, wordware_api_key)
        ...
        cultural_differences = do_wordware("cultural-prompt-id", inputs, wordware_api_key)
        ...
        recommendations = do_wordware("recommendation-prompt-id", inputs, wordware_api_key)
